##### Приложение представляет собой flask сервер и базу данных. Сервер работает на порту 5000 и на корневой ручке выдает "SELECT *" из таблицы films в БД postgres. БД находится в том же контейнере.
